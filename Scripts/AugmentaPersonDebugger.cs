...
public class AugmentaPersonDebugger : MonoBehaviour {
    ...
    void Update () {
        ...
        if (AugmentaAreaAnchor.linkedAugmentaArea.protocolVersion == ProtocolVersion.v1) {
        ...
        } else if (AugmentaAreaAnchor.linkedAugmentaArea.protocolVersion == ProtocolVersion.v2) {
